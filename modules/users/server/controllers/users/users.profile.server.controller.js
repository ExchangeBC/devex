...
var whitelistedFields = [
	...
	'divisionalFinancialStaffEmail',
	'assistantDeputyMinisterEmail',
	'branchFinancialStaffEmail',
	'businessName'     ,
	'businessAddress'  ,
	'businessAddress2' ,
	'businessCity'     ,
...
exports.me = function (req, res) {
	...
	if (req.user) {
		safeUserObject = {
			...
			divisionalFinancialStaffEmail: validator.escape(req.user.divisionalFinancialStaffEmail),
			assistantDeputyMinisterEmail : validator.escape(req.user.assistantDeputyMinisterEmail),
			branchFinancialStaffEmail	 : validator.escape(req.user.branchFinancialStaffEmail),
