...
exports.update = function (req, res) {
  ...
  user.divisionalFinancialStaffEmail = req.body.divisionalFinancialStaffEmail;
  user.assistantDeputyMinisterEmail = req.body.assistantDeputyMinisterEmail;
  user.branchFinancialStaffEmail = req.body.branchFinancialStaffEmail;
