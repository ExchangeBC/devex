  ...
  function GovController($scope, $state, $window, Authentication, user, Notification) {
    ...
    function update(isValid) {
      ...
      user.$update(function () {
        ...
        Notification.success({ message: '<i class="fas fa-check-circle"></i> User saved successfully!' });
      }, function (errorResponse) {
        Notification.error({ message: errorResponse.data.message, title: '<i class="fas fa-exclamation-triangle"></i> User update error!' });
      });
    }
