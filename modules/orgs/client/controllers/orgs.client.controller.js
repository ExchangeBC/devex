(function() {
	...
	angular
		...
		//
		// =========================================================================
		.controller('OrgAdminController', function($rootScope, $state, org, OrgsService) {
			var vm = this;
			vm.org = org;
		...
		//
		// =========================================================================
		.controller('OrgProfileController', function(
			$rootScope,
			capabilities,
			$scope,
			$state,
		...
		//
		// =========================================================================
		.controller('OrgMembersController', function(
			$rootScope,
			org,
			Notification,
			OrgsService,
