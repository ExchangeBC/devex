...
(function() {
	...
	angular
		...
		//
		// =========================================================================
		.controller('OpportunityViewSWUController', function(
			capabilities,
			$state,
			$stateParams,
			$sce,
		...
		//
		// =========================================================================
		.controller('OpportunityEditSWUController', function(
			$scope,
			capabilities,
			$state,
			$stateParams,
			...
			vm.selectSkills = function(e) {
				...
				Object.keys(vm.all.iCapabilities).forEach(function(code) {
					vm.all.iOppCapabilities[code] =
						vm.inp.iOppCapabilities[code] || vm.prp.iOppCapabilities[code] || vm.imp.iOppCapabilities[code];
				});
				//
