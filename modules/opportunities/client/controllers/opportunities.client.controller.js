(function() {
	...
	angular
		...
		// 	function($state, $stateParams, $sce, $location, opportunity, authenticationService, opportunitiesService, proposalService, Notification, modalService, ask, myproposal, opportunitiesCommonService) {
		// 		if (!opportunity) {
		...
		// 				opportunitiesService.getOpportunityResourceClass().get({
		...
		// 			proposalService.getProposalsForOpp({ opportunityId: vm.opportunity._id }).$promise.then(function(
		// 				proposals
		// 			) {
		...
		// 			var publishMethod = isToBePublished ? OpportunitiesService.getOpportunityResourceClass().publish : OpportunitiesService.getOpportunityResourceClass().unpublish;
		...
		// 				if (r) {
		// 					OpportunitiesService.getOpportunityResourceClass().unassign({ opportunityId: opportunity._id, proposalId: opportunity.proposal._id }).$promise.then(
		// 						function(response) {
