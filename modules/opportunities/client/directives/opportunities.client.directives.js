								...
								.then(function() {
									if (savemeSeymour) {
										...
										if (state)
											...
											return OpportunitiesService.unpublish({ opportunityId: opportunity._id })
												.$promise;
		...
		.directive('opportunityList', [
			...
			function($state) {
				return {
					...
					controller: function($scope, OpportunitiesService, Authentication, Notification, UsersService) {
						var vm = this;
