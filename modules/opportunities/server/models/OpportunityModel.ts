...
//
// -------------------------------------------------------------------------
interface IOpportunityModel extends Model<IOpportunityDocument> {
...
const OpportunityModel: IOpportunityModel = model<IOpportunityDocument, IOpportunityModel>('Opportunity', OpportunitySchema);
