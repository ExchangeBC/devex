...
export class ProjectsPolicy {
	...
	public isAllowed = (req, res, next) => {
		...
		if (
			...
			req.user &&
			req.project.user &&
			req.project.user.id === req.user.id
		) {
			return next();
		}

		// Check for user roles
		this.aclMem.areAnyRolesAllowed(
			roles,
			req.route.path,
		...
		this.aclMem.allow([
			{
				...
				allows: [
					...
					{
						resources:
							'/api/projects/requests/confirm/:projectId/:userId',
						permissions: ['get']
					},
					{
						resources:
							'/api/projects/requests/deny/:projectId/:userId',
						permissions: ['get']
					},
					{
			...
			},
			{
				...
				allows: [
					...
					{
						resources:
							'/api/projects/members/:projectId/confirm/:userId',
						permissions: ['get']
					},
					{
						resources:
							'/api/projects/requests/:projectId/deny/:userId',
						permissions: ['get']
					},
					{
						resources: '/api/projects/:projectId',
