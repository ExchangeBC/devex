  ...
  describe('Programs Route Tests', function () {
    ...
    describe('Route Config', function () {
      ...
      describe('Create Route', function () {
        ...
        it('should respond to URL', inject(function ($state) {
          expect($state.href(createstate)).toEqual('/programs/create');
        }));
        ...
        it('Should have templateUrl', function () {
          expect(createstate.templateUrl).toBe('modules/programs/client/views/form-program.client.view.html');
        });
      });
      ...
      describe('Edit Route', function () {
        ...
        it('Should have templateUrl', function () {
          expect(editstate.templateUrl).toBe('modules/programs/client/views/form-program.client.view.html');
        });
