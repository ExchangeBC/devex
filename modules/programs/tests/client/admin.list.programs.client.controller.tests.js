(function () {
  ...
  describe('Admin Programs List Controller Tests', function () {
    // Initialize global variables
    var ProgramsAdminListController,
      $scope,
      $httpBackend,
      $state,
      Authentication,
    ...
    beforeEach(inject(function ($controller, $rootScope, _$state_, _$httpBackend_, _Authentication_, _ProgramsService_) {
      ...
      $httpBackend.whenGET('/modules/programs/client/views/list-programs.client.view.html').respond(200, '');
      ...
      ProgramsAdminListController = $controller('ProgramsAdminListController as vm', {
        $scope: $scope
      });
