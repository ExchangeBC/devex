(function () {
  ...
  describe('Admin Teams List Controller Tests', function () {
    // Initialize global variables
    var TeamsAdminListController,
      $scope,
      $httpBackend,
      $state,
      Authentication,
    ...
    beforeEach(inject(function ($controller, $rootScope, _$state_, _$httpBackend_, _Authentication_, _TeamsService_) {
      ...
      $httpBackend.whenGET('/modules/teams/client/views/list-teams.client.view.html').respond(200, '');
      ...
      TeamsAdminListController = $controller('TeamsAdminListController as vm', {
        $scope: $scope
      });
