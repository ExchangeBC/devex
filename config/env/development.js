...
module.exports = {
  db: {
    uri: process.env.MONGOHQ_URL || process.env.MONGODB_URI || 'mongodb://' + (process.env.MONGODB_SERVICE_HOST || process.env.DB_DEVEX_PORT_27017_TCP_ADDR || 'localhost') + ':' + (process.env.MONGODB_PORT || '27017') + '/' + (process.env.MONGODB_DATABASE || 'mean-dev'),
    options: {
