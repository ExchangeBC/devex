	...
	return clearTemplates ().then (function () {
		return Promise.all ([
			new T ({
				...
				messageBodyTemplate  : '<p>Hi {{user.name}}</p><br/><p><strong>{{Inviter.name}}</strong> has invited you to join <strong>{{org.name}}</strong>.</p><p>If you accept, {{org.name}} will be able to put you forward as a team member on proposals for <i>Sprint With Us</i> opportunities.',
				messageShortTemplate : 'You\'ve been invited to join {{org.name}}',
				messageTitleTemplate : 'company {{org.name}}?',
				emailBodyTemplate    : '<p>Hi {{user.name}}</p><br/><p><strong>{{Inviter.name}}</strong> has invited you to join <strong>{{org.name}}</strong> so they can put you forward as a team member on a proposal.</p>',
			...
			new T ({
				...
				isSubscriptionType   : false,
				messageBodyTemplate  : '<p>Hi there!</p><br/><p><strong>{{Inviter name}}</strong> has invited you to sign up on the BCDevExchange and join <strong>{{org.name}}</strong>.</p>',
