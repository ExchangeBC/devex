	...
	return clearTemplates ().then (function () {
		return Promise.all ([
			...
			new T ({
				...
				isSubscriptionType   : true,
				messageBodyTemplate  : '<p>A new <i>Code With Us</i> opportunity has just been posted:</p><h4><a href="{{ domain }}/{{opportunity.path}}">{{opportunity.name}}</a></h4>',
				messageShortTemplate : '',
			...
			new T ({
				...
				description          : 'notify the user that there is a new opportunity' ,
				isSubscriptionType   : true,
				messageBodyTemplate  : '<p>A new <i>Sprint With Us</i> opportunity has just been posted:</p><h4><a href="{{ domain }}/{{opportunity.path}}">{{opportunity.name}}</a></h4>',
				messageShortTemplate : '',
				messageTitleTemplate : 'A new opportunity has just been posted!',
			...
			new T ({
				...
				isSubscriptionType   : true,
				messageBodyTemplate  : '<p>🎉 <strong>Congratulations!</strong> 🎉</p><p>Your proposal to work on <strong><a href="{{ domain }}/{{opportunity.path}}">{{ opportunity.name }}</a></strong> has been selected! <strong>{{opportunity.assignor}}</strong> is offering the assignment to you.',
			...
			new T ({
				...
				description          : 'notify the user that they have been assigned the opportunity' ,
				isSubscriptionType   : true,
				messageBodyTemplate  : '<p>🎉 <strong>Congratulations!</strong> 🎉</p><p>The team you put forward to work on <strong><a href="{{ domain }}/{{opportunity.path}}">{{ opportunity.name }}</a></strong> has been selected!</p>',
				messageShortTemplate : '<a href="{{ opportunity.path }}">{{ opportunity.name }}</a>',
				messageTitleTemplate : 'Your Proposal has been selected!',
