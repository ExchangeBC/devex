...
class OrgDetailsPage extends Page {
	...
	static content = {
            ...
            AcceptJoinRequestButtons(wait: true) { $("button", 'data-automation-id': "btnAcceptMember") }
            DeclineJoinRequestButtons(wait: true) { $("button", 'data-automation-id': "btnDeclineMember") }
            ModalButtonYes(wait: true) { $("button", 'data-automation-id': "button-modal-yes") }
            ModalButtonNo(wait: true) { $("button", 'data-automation-id': "button-modal-no") }
            BusinessRegistrationLabel(wait: true) { $('data-automation-id': 'lblBusinessRegistration') }
            CompanyInfoEditButton(wait: true) { $("button", 'data-automation-id': "btnEdit_right") }
            PostalCodeLabel(wait: true) { $("div", 'data-automation-id': "lblBusinessCityPostalCode") }
            BusinessContactNameLabel(wait: true) { $("div", 'data-automation-id': "lblBusinessContactName") }
    }
}
